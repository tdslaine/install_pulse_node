...
function get_user_choices() {
    ...
    echo ""
    echo "---------------------------------------"
    echo "1. Lighthouse - single key exit using g4mm4s external API (exit regardless if you are synced or not)"
    echo "2. Lighthouse - multiple keys exit using g4mm4s external API (exit regardless if you are synced or not)"
    echo "---------------------------------------"

...
GETH_CMD="sudo -u geth docker run -t --restart=always --restart-delay=60 \\
--network=host \\
--name execution \\
...
ERIGON_CMD="sudo -u erigon docker run --restart=always --restart-delay=60 \\
--network=host \\
--name execution \\
-v ${CUSTOM_PATH}:/blockchain \\
...
PRYSM_CMD="sudo -u prysm docker run -t --restart=always --restart-delay=60 \\
--network=host \\
--name beacon \\
-v ${CUSTOM_PATH}:/blockchain \\
...
LIGHTHOUSE_CMD="sudo -u lighthouse docker run -t --restart=always --restart-delay=60 \\
--network=host \\
--name beacon \\
-v ${CUSTOM_PATH}:/blockchain \\

...
echo ""
echo -e "${GREEN}Initial node and validator setup complete! Begin syncing Pulse chain by starting execution, consensus, and later on the validator clients.${NC}"
echo -e "${GREEN}Enter cd \"$custompath\" in your terminal to access the script directory.${NC}"
echo -e "${GREEN}Run ./start_execution.sh, ./start_consensus.sh, and ./start_validator.sh to start the clients.${NC}"
echo ""
